...
public class World
{
	...
	World(World w)
	{
        ...
        connectRooms();
        placeStairCase();
        populateWorldWithMoreDifficultEnemies(); //adds things to the world	    
	}
    ...
    private void populateWorldWithMoreDifficultEnemies()
    {
        Random gen = new Random();
        int enemiesToMake = gen.nextInt(maxEnemies) + minEnemies;
        int enemiesMade = 0;
        ...
        while(enemiesMade < enemiesToMake)
        {
            ...
            newEnemies.add(new Enemy(enemies.get(0)));
            enemiesMade++;     
        }
