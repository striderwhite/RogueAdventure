...
public class Player extends Entity 
{
    ...
    Player(int x, int y, World world, Block_Type type)
    {
    ...
    Player(int x, int y, World world, Block_Type type, Player player)
    {
        super(x, y, world, type);
        level = player.level;
	...
	{
        if(typeBeforeEntityMoved == Block_Type.UPSTAIRS || typeBeforeEntityMoved == Block_Type.DOWNSTAIRS )
        {
            return true;
        }
        else
