...
public class Tile implements Serializable
{
    ...
    Tile(int x, int y) // this constructor chooses a type randomly
    { 
    ...
    {
        if(type == Tile_Type.WALL || type == Tile_Type.PLAYER || type == Tile_Type.NONE || type == Tile_Type.ENEMY || type == Tile_Type.STAIRS )
        {
            return false;
        }
        else
	...
	public PathNode toPathNode(PathNode parent) 
	{
		return new PathNode(parent,x,y);
	}
