...
public class World
{
	...
	protected Point spawnPoint, downstairsPoint;
	...
	*/
	...
	World()
	{
	    ...
	    downstairsPoint = new Point(rooms[getRoomCount()-1].centerX , rooms[getRoomCount()-1].centerY); //location to place the upstairs
	    
	    blocks[spawnPoint.x][spawnPoint.y].setType(Block_Type.UPSTAIRS);
	    blocks[downstairsPoint.x][downstairsPoint.y].setType(Block_Type.DOWNSTAIRS);
	...
	/*
	 * 
	 * creates a new world and assigns its parameters relative to the given world
