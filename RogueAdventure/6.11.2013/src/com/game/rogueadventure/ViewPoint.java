            ...
            switch(event.getAction())
                {        
                    ...
                    case(MotionEvent.ACTION_MOVE):
                    {
                        ...
                        game.overworldGraphics.view_point_x =  (int) ( game.overworldGraphics.view_point_x + ( ( event.getX() - pointerOneInitalX ) /24 ) ); // 24 for smoothing
                        game.overworldGraphics.view_point_y =  (int) ( game.overworldGraphics.view_point_y + ( ( event.getY() - pointerOneInitalY ) /24 ) );
                        game.overworldGraphics.invalidate(); // force redraw
                    }   
