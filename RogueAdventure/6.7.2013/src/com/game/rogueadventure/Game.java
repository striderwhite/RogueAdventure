...
public class Game extends Activity 
{
	...
	{
        world = new World();
        worlds.put(Integer.valueOf(floor),world);
        worldEnemies.put(world, world.enemies);
        Toast.makeText(this, "On floor " + floor, Toast.LENGTH_LONG).show();
        player = new Player( world.spawnPoint.x, world.spawnPoint.y , world , Block_Type.PLAYER);
        
        if(floor != 1)//if its not the first floor create upstairs 
        {
